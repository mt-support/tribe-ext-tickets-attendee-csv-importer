...
class Integration extends Integration_Base {
	 ...
	 * @var string
	 */
	public $type = 'tribe_tpp_attendees';
	 ...
	 * @var string
	 */
	public $orm_type = 'tribe-commerce';
	 ...
	 * @var string
	 */
	public $event_meta_key = '_tribe_tpp_for_event';
	...
	public function get_import_label() {
		return __( 'Ticket Attendees (Tribe Commerce)', 'tribe-ext-tickets-attendee-csv-importer' );
	}
	...
	public function add_csv_post_type( $post_types ) {
		...
		if ( empty( $active_modules['Tribe__Tickets__Commerce__PayPal__Main'] ) ) {
			return $post_types;
		}
